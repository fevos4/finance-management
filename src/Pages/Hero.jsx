...
const Hero = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await login(slipNumber, idNumber);
            navigate("/dashboard");
        } catch (err) {
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8">
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-500">
                                Demo credentials: Slip Number: <span className="font-mono bg-gray-100 px-2 py-1 rounded">123</span>, ID: <span className="font-mono bg-gray-100 px-2 py-1 rounded">456</span>
                            </p>
                        </div>
                    </div>
                </div>
